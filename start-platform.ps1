...
# 1. Start Backend (Node/Express em 3002)
Write-Host "[1/2] Iniciando Backend Server (Port 3002)..." -ForegroundColor Yellow
...
Write-Host "⚙️  Acesso Backend: http://localhost:3002/maquinadeteste" -ForegroundColor White
